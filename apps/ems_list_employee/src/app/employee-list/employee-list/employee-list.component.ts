  ...
  template: `
    <div class="container-fluid py-4">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h4 mb-0 text-primary fw-bold">Employee Management</h2>
      ...
      <!-- Pagination -->
      <nav *ngIf="!vm.loading() && vm.totalPages() > 1" class="d-flex justify-content-center">
        <ul class="pagination pagination-sm shadow-sm">
          <li class="page-item" [class.disabled]="vm.currentPage() === 1">
            <a class="page-link" (click)="vm.setPage(vm.currentPage() - 1)" style="cursor: pointer;">Previous</a>
          </li>
          ...
          <li class="page-item" [class.disabled]="vm.currentPage() === vm.totalPages()">
            <a class="page-link" (click)="vm.setPage(vm.currentPage() + 1)" style="cursor: pointer;">Next</a>
          </li>
        </ul>
      </nav>
